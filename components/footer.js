          ...
          <div className="max-w-screen-xl mx-auto ">
            <div className="grid grid-cols-8 md:grid-cols-9  lg:grid-cols-8  divide-gray-200 divide-y-2 md:divide-x-2 md:divide-y-0 md:-mx-8">
              ...
              <div className="col-span-8 md:col-span-3 lg:col-span-3 md:px-8 py-4 md:py-0">
                <h5 className="text-xl font-semibold text-gray-700">Industries</h5>
                <nav className="mt-4">
                  <ul claclassNamess="grid lg:grid-cols-2">
                    <li className="mb-2">
                      <a href="#" className="font-normal text-base hover:text-gray-400">Employment</a>
                    </li>
                    <li className="mb-2">
                      <a href="#" className="font-normal text-base hover:text-gray-400">Company</a>
                    </li>
                    <li class="mb-2">
                      <a href="#" className="font-normal text-base hover:text-gray-400">Childcare</a>
                    </li>
                    <li class="mb-2">
                      <a href="#" className="font-normal text-base hover:text-gray-400">Download brochure</a>
                    </li>
                  </ul>
                </nav>
              </div>
